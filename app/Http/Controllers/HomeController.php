...
class HomeController extends Controller
{
    ...
    public function add_cart(Request $request, $id)
    {
        if (Auth::id())
        {
            ...
            if($product_exist_id)
            {
                ...
                Alert::success('Produto adicionadao com sucesso');
    ...
    public function cancel_order($id)
    {
        ...
        $order->delivery_status = 'Voce cancelou o pedido';
    ...
    public function product_search(Request $request)
    {
        ...
        $product = Product::where('title', 'LIKE', "%$search_text%")->where('catagory', 'LIKE', "$search_text")->paginate(10);
